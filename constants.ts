...
export const MOCK_COMPONENTS: Component[] = [
    ...
    { id: 'm2', name: 'Arduino Nano', type: 'Microcontroller', description: 'Breadboard-friendly version of the Uno.', voltage: '5V', pins: '14 Digital, 8 Analog', commonUses: ['Compact Projects'], difficulty: Difficulty.BEGINNER, datasheetUrl: 'https://www.arduino.cc/en/uploads/Main/ArduinoNanoManual23.pdf' },
    { id: 'm3', name: 'Arduino Mega 2560', type: 'Microcontroller', description: 'More pins and memory for large projects.', voltage: '5V', pins: '54 Digital, 16 Analog', commonUses: ['3D Printers', 'Complex Robotics'], difficulty: Difficulty.INTERMEDIATE, datasheetUrl: 'https://docs.arduino.cc/resources/datasheets/A000067-datasheet.pdf' },
    { id: 'm4', name: 'ESP32 Dev Module', type: 'Microcontroller', description: 'Powerful dual-core with WiFi & Bluetooth.', voltage: '3.3V', pins: '30+ GPIO (Touch, DAC)', commonUses: ['IoT', 'Audio Streaming', 'Cameras'], difficulty: Difficulty.ADVANCED, datasheetUrl: 'https://www.espressif.com/sites/default/files/documentation/esp32_datasheet_en.pdf' },
    ...
    { id: 'm6', name: 'Raspberry Pi Pico', type: 'Microcontroller', description: 'RP2040 Dual Core ARM Cortex-M0+.', voltage: '3.3V', pins: '26 GPIO', commonUses: ['MicroPython', 'High Performance'], difficulty: Difficulty.INTERMEDIATE, datasheetUrl: 'https://datasheets.raspberrypi.com/pico/pico-datasheet.pdf' },
    ...
    // --- Sensors ---
    { id: 's1', name: 'DHT11', type: 'Sensor', description: 'Basic digital temperature and humidity sensor.', voltage: '3-5V', pins: 'VCC, DATA, GND', commonUses: ['Weather'], difficulty: Difficulty.BEGINNER, datasheetUrl: 'https://www.mouser.com/datasheet/2/758/DHT11-Technical-Data-Sheet-Translated-Version-1143054.pdf' },
    ...
    { id: 's3', name: 'BME280', type: 'Sensor', description: 'Temperature, Humidity, and Barometric Pressure.', voltage: '3.3V', pins: 'I2C/SPI', commonUses: ['Altimeter', 'Weather Station'], difficulty: Difficulty.INTERMEDIATE, datasheetUrl: 'https://www.bosch-sensortec.com/media/boschsensortec/downloads/datasheets/bst-bme280-ds002.pdf' },
